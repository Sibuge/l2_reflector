/*
 * Copyright (c) 2022-2023 NVIDIA CORPORATON & AFFILIATES, ALL RIGHTS RESERVED.
 *
...
#define SRC_MAC (0xa088c232066a) // node1 192.168.200.1
#define DST_MAC (0xa088c231d8d8) // node2 192.168.200.2

/* 是用来详细描述一个流匹配规范（match specification）的数据结构 */
/* 这种结构通常用于底层网络编程，特别是在创建网络流过滤规则时，它可以精确地指定要匹配的数据包头部字段 */
